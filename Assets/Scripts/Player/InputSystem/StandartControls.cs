...
public partial class @StandartControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Torque"",
                    ""type"": ""Button"",
                    ""id"": ""c20a4904-f3c7-45fe-9af6-9384bfbc7867"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""45c9da5d-751e-471c-984b-983ec2629789"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""4953a870-c3b7-46c3-8c97-0b23cb728e25"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""00f1f75c-e219-42ba-a8d9-707046fe0ffb"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""9c4e1b54-2cbe-446d-b9d9-f3764080a500"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""f1e75801-f9c9-48b2-aa93-dc7417ad10b2"",
    ...
    ""controlSchemes"": []
        ...
        m_DriveControl_Torque = m_DriveControl.FindAction("Torque", throwIfNotFound: true);
        // UIControl
    ...
    ~@StandartControls()
    {
        UnityEngine.Debug.Assert(!m_DriveControl.enabled, "This will cause a leak and performance issues, StandartControls.DriveControl.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UIControl.enabled, "This will cause a leak and performance issues, StandartControls.UIControl.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_MusicControl.enabled, "This will cause a leak and performance issues, StandartControls.MusicControl.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_FPSButton.enabled, "This will cause a leak and performance issues, StandartControls.FPSButton.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_DriveControl_Torque;
    public struct DriveControlActions
    {
        ...
        public InputAction @Torque => m_Wrapper.m_DriveControl_Torque;
